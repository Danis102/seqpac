#' Adds repeat annotation to PAC object
#'
#' Annotates repeats to a PAC object using repeatMasker gtf or UCSC table output
#'
#' Given a PAC object and genomic coordinates of repeats this functions 
#' 
#' @family PAC analysis
#'   
...
#' dat_pirna <- ref_pirna[!is.na(ref_pirna$seq),]
#' 
