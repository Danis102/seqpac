...
#' reanno <- make_reanno(reanno_path=output_genome, 
#'                       PAC=pac, mis_fasta_check = TRUE)
...
#' bio_search <- list(
#'                 miRNA="dme-",
#'                 Ensembl =c("miRNA", "pre_miRNA", "rRNA", "snoRNA","snRNA", 
#'                            "tRNA", "Uhg", "7SLRNA", "asRNA", "hpRNA", 
#'                           "RNaseMRP","RNaseP", "sbRNA", "scaRNA", "sisRNA", 
#'                           "snmRNA", "snoRNA", "snRNA","Su\\(Ste\\)"),
...
#' bio_search <- list(
#'                 miRNA="dme-",
#'                 Ensembl =c("lincRNA", "miRNA", "pre_miRNA", "rRNA",  
#'                           "snoRNA", "snRNA", "tRNA", "Uhg", "7SLRNA",  
#'                           "RNaseMRP","RNaseP", "sbRNA", "scaRNA", "sisRNA", 
#'                           "asRNA", "hpRNA", "snmRNA", "snoRNA", "snRNA",
#'                           "Su\\(Ste\\)"),
#'                 rRNA    =c("5.8S", "28S", "18S", "rRNA"),
#'                 tRNA    =c("^tRNA"),
#'                 piRNA   =c("piR-"))
#'                 
#' anno <- add_reanno(reanno, bio_search=bio_search, 
#'                    type="biotype", bio_perfect=FALSE, mismatches = 0)
#' 
