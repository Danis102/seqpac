...
#' also use a coercion method, e.g. \code{PAC_S3 <- as(PAC_S4, "S3")}
#' 
#' Holds up to 6 slots: \describe{
...
#'    \item{\emph{reanno (optional)}}{list of reanno objects > results from reannotation }
#'    }
#'    
#' @rdname PAC
#' @export
