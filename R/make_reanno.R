...
#' reanno_path <- "/home/danis31/Desktop/Temp_docs/reanno_srna" # Path to map_reanno output (biotype)
#' reanno_path <- "/home/danis31/Desktop/Temp_docs/reanno_genome" # Path to map_reanno output (genome)
#' Full_anno <- make_reanno(reanno_path, PAC=pac_master, mis_fasta_check=TRUE)   
#' 
