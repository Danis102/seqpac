...
#' from Pheno, class information from Anno, and summaries this over the data
#' in Counts or norm to generate a stacked (percent) bar.
#'
#' @family PAC analysis
#'
...
#'   summary= all" a mean of all samples. (Default="samples").
#'   
...
#'   bar, where deafult is "percent", showing the percentage of the anno_target
#'   on whole amount of reads. Other option is "total", where the total amount of
