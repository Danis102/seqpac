...
#'   should be a counts list object generated by \code{make_counts2} with
...
#'   possible to generate progress report from make_counts2 if cutadapt=FALSE.
#'   If type="sport", input needs to be a path to a folder with Sports output
