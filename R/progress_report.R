...
#'   generated by \code{make_counts2}.
#'
#' @param type Character indicating what type of input. If type="seqpac", input
#'   should be a counts list object generated by \code{make_counts2}, which
#'   contains a $counts table and $logs list with logs generated by cutadapt and
#'   fastq_quality_filter. If type="sport", input needs to be a path to a folder
#'   with Sports output files. The function will search this path for the the
#'   progress_report folder that is automatically generated by Sports running
#'   with the -k option (save all intermediate files).
#'
#' @return data.frame
#'
#' @examples
